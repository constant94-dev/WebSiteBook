...
let requestOptions = {
    method: "GET",
    uri: "http://www.kyobobook.co.kr/categoryRenewal/categoryMain.laf?perPage=20&mallGb=ENG&linkClass=11&menuCode=002",
...
request(requestOptions, function (error, response, body) {
    ...
    if (!error) {
        ...
        bodyList.each(function (i) {
            ...
            var sql = 'INSERT INTO bct_foreign_crawl (image, title, author, info) VALUES(?,?,?,?)';
            var params = [cr_image, cr_title, cr_author, cr_info];
            // SQL문 실행
